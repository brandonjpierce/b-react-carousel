(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["HawkCarousel"] = factory();
	else
		root["HawkCarousel"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dots = __webpack_require__(165);
	...
	var Carousel = (function (_Component) {
	  ...
	  function Carousel(props) {
	    ...
	    _this.state = {
	      ...
	      cellCount: _react.Children.count(props.children)
	    };
	    return _this;
	  }
	  ...
	  _createClass(Carousel, [{
	    key: 'handleDimensions',
	    value: function handleDimensions(containerWidth) {
	      var _props = this.props;
	      var cellsToShow = _props.cellsToShow;
	      var cellSpacing = _props.cellSpacing;
	      var cellCount = this.state.cellCount;

	      var cellWidth = Math.ceil(containerWidth / cellsToShow) - cellSpacing;
	      var sliderWidth = cellCount * cellWidth + cellCount * cellSpacing;
	    ...
	    key: 'handleTo',
	    value: function handleTo(index) {
	      var cellSpacing = this.props.cellSpacing;
	      var _state = this.state;
	      var currentCell = _state.currentCell;
	    ...
	    value: function handleNext() {
	      ...
	      var currentCell = _state2.currentCell;
	      var cellCount = _state2.cellCount;
	      var _props2 = this.props;
	      var cellsToSlide = _props2.cellsToSlide;
	      var cellsToShow = _props2.cellsToShow;

	      var nextBatch = currentCell + cellsToSlide;
	      var isEnd = cellsToShow >= cellsToSlide ? nextBatch + cellsToShow > cellCount : nextBatch >= cellCount;

	      var computedIndex = isEnd ? cellCount - cellsToShow : nextBatch;
	    ...
	    value: function handlePrev() {
	      ...
	      var currentCell = _state3.currentCell;
	      var cellCount = _state3.cellCount;
	      var cellsToSlide = this.props.cellsToSlide;

	      var computedIndex = currentCell - cellsToSlide < 0 ? 0 : currentCell - cellsToSlide;
	    ...
	    value: function render() {
	      ...
	      var animationSpeed = _props3.animationSpeed;
	      var animationEasing = _props3.animationEasing;
	      var cellSpacing = _props3.cellSpacing;
	      var cellAlign = _props3.cellAlign;
	      var cellsToShow = _props3.cellsToShow;
	      var cellsToSlide = _props3.cellsToSlide;
	      var _state4 = this.state;
	      var cellCount = _state4.cellCount;
	      var currentCell = _state4.currentCell;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _container2.default,
	          {
	            ...
	            width: sliderWidth,
	            offset: offset,
	            handleDimensions: function handleDimensions(width) {
	              return _this2.handleDimensions(width);
	            } },
	        ...
	        _react2.default.createElement(_dots2.default, {
	          ...
	          handleTo: function handleTo(index) {
	            return _this2.handleTo(index);
	          }
	        })
	      );
	    }
	...
	var Test = (function (_Component2) {
	  ...
	  _createClass(Test, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        Carousel,
	        { cellsToShow: 1, cellsToSlide: 1, cellSpacing: 0 },
	        _react2.default.createElement(
	          'div',
	          { className: 'test-item' },
	          '1'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPrefixr = __webpack_require__(159);
	...
	var Container = (function (_Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function componentWillMount() {
	      window.addEventListener('resize', (0, _debounce2.default)(this.getDimensions.bind(this)));
	    }
	    ...
	    value: function getDimensions() {
	      var handleDimensions = this.props.handleDimensions;

	      handleDimensions((0, _utils.outerWidth)(this.refs.sliderContainer));
	    }
	    ...
	    value: function getSliderStyles() {
	      ...
	      return (0, _reactPrefixr2.default)(styles);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var sliderStyles = this.getSliderStyles();

	      return _react2.default.createElement(
	        'div',
	        { ref: 'sliderContainer', className: 'hawk-carousel__viewport' },
	        _react2.default.createElement(
	          'div',
	          { className: 'hawk-carousel__slider', style: sliderStyles },
	          children
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = (function (_Component) {
	  ...
	  _createClass(Navigation, [{
	    ...
	    value: function render() {
	      var _props = this.props;
	      var handleNext = _props.handleNext;
	      var handlePrev = _props.handlePrev;

	      return _react2.default.createElement(
	        "div",
	        { className: "hawk-carousel__navigation" },
	        _react2.default.createElement(
	          "button",
	          {
	            type: "button",
	...
	var Item = (function (_Component) {
	  ...
	  _createClass(Item, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'hawk-carousel__item', style: styles },
	        child
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dots = (function (_Component) {
	  ...
	  _createClass(Dots, [{
	    ...
	    key: 'getDotIndexes',
	    value: function getDotIndexes() {
	      var _props = this.props;
	      var cellsToShow = _props.cellsToShow;
	      var cellsToSlide = _props.cellsToSlide;
	      var cellCount = _props.cellCount;
	      var currentCell = _props.currentCell;

	      var showHigherThanSlide = cellsToShow > cellsToSlide;
	      var divisionFactor = showHigherThanSlide ? cellsToSlide : cellsToShow;
	      var dotCount = Math.ceil(cellCount / divisionFactor);

	      var lastIndex = 0;
	      var indexes = [0];

	      for (var i = 1; i < dotCount; i++) {
	        var nextBatch = lastIndex + cellsToSlide;
	        var isEnd = cellsToShow >= cellsToSlide ? nextBatch + cellsToShow > cellCount : nextBatch >= cellCount;
	    ...
	    value: function render() {
	      var _props2 = this.props;
	      var handleTo = _props2.handleTo;
	      var currentCell = _props2.currentCell;
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'hawk-carousel__dots' },
	        indexes.map(function (index) {
	          var classes = (0, _classnames2.default)('hawk-carousel__dot', { 'hawk-carousel__dot--active': index === currentCell });
